...
def snippet_4():
    ...
    # the first value is a false boolean value. or means one conditon has to be true. the not makes the following conditon false. With the not it becomes a false condtion .
    #  8 is less than 20 is true but the not the not makes it flase
snippet_4()
